...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { hours: @destination.hours, name: @destination.name, website: @destination.website } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { hours: @destination.hours, name: @destination.name, website: @destination.website } }
