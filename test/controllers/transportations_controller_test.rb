...
class TransportationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transportation" do
    assert_difference('Transportation.count') do
      post transportations_url, params: { transportation: { hours: @transportation.hours, name: @transportation.name, website: @transportation.website } }
    end
  ...
  test "should update transportation" do
    patch transportation_url(@transportation), params: { transportation: { hours: @transportation.hours, name: @transportation.name, website: @transportation.website } }
